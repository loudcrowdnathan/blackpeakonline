...
namespace App\Http\Controllers\Blackpeak;
...
class ResourceController extends Controller
{
  ...
  public function Less(){
        ...
        $css = app('App\Http\Controllers\Blackpeak\ResourceController')->minify_css($parser->getCss());
        ...
        $compiled = app('App\Http\Controllers\Blackpeak\ResourceController')->minify_css($compiled);
